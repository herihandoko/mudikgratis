                    ...
                    <div class="card-body">
                        <form action="{{route('admin.mudik-kota.update', $category->id)}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" name="tgl_keberangkatan" value="{{ $category->tgl_keberangkatan }}">
                            </div>
                            <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        }else sel_content = '<option value="' + value.id + '">' + value.name + '</option>';

@php
$page_title = "Admin | Pemberhentian Mudik";
@endphp
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Setting Pemberhentian Bus (Pengaturan untuk rute perjalanan)</h1>
            </div>
            ...
            <div class="card text-dark">
                <div class="card-body">
                    <form action="{{ route('admin.setting-stop.index') }}" method="GET">
...
@push('script')
    {{$dataTable->scripts()}}
    <script>
        onChangeSelect('{{ route('admin.setting-stop.combo') }}', $('#sel-tujuan').val());
        $('#sel-tujuan').on('change', function() {
            onChangeSelect('{{ route('admin.setting-stop.combo') }}', $(this).val());
        });

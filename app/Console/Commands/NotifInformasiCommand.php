    ...
    public function handle()
    {
        ...
        if ($users && !$groupNotif) {
            ...
            foreach ($users as $key => $user) {
                $ttlAnggota++;
                $message = "Informasi Resmi Mudik Gratis  Pemerintah Provinsi Banten Tahun 2025 bisa di liat langsung melalui :\n1.⁠ ⁠Instagram Dishub Banten https://www.instagram.com/share/p/_ZCamx-rs\n2.⁠ ⁠Pendaftaran dan info kota tujuan serta rute lintasan dapat di akses melalui link https://jawaramudik.bantenprov.go.id/\n3.⁠ ⁠Syarat utama pendaftar E-KTP Provinsi Banten dan pendaftaran dibuka pukul 00.00 WIB pada tanggal 2 maret s/d 25 maret 2025\n4.⁠ ⁠Tanggal keberangkatan 26 maret 2025 (tentatif menyesuaikan libur bersama) dan titik lokasi keberangkatan di Kawasan Pusat Pemerintahan Provinsi Banten(KP3B) Palima Kota Serang\n5.⁠ ⁠Tutorial dan Tata Cara Pendaftaran Mudik Gratis Tahun 2025\n5.1.⁠ ⁠Modul tata cara pendaftaran mudik Dishub Banten https://ppid.bantenprov.go.id/storage/document/buku-panduan-mudik-gratis-aplikasi-jawaramudik-202502191646.pdf\n5.2.⁠ ⁠Vidio tutorial https://www.instagram.com/reel/DGQBvhfTIe_/?igsh=MWR2MXlydmJxZHZ1ZA==";
                $param = [
                    'target' => $user->phone,
                    'message' => $message
                ];
